...
- **🔄 Automated CI/CD & Version Notifications**: Built with GitHub Actions CI/CD and built-in in-app update notifications.
...
You can run Music Manager either via the **pre-built container** (recommended) or by **building from source**.
...
2. **Configure your paths:**
   ```bash
   cp .env.example .env
   # Edit .env to set your STORAGE_PATH or MUSIC_PATH and NEW_MUSIC_PATH folders
   ```
